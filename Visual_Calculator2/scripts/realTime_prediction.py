...
def main():
    interpreter = tflite.Interpreter(model_path= '/home/pi/visual_calculator2/Project_2: Visual Calculator/data/model/vc_model.tflite')
    labels = ["divide" , "eight","five","four","min","multiply","nine","one",
              "plus","seven","six","three","two"]
